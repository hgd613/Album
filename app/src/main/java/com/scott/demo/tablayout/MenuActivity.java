...
public class MenuActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(SixFragment.newInstance());
        fragments.add(SevenFragment.newInstance());
        fragments.add(EightFragment.newInstance());
        fragments.add(NineFragment.newInstance());
        fragments.add(TenFragment.newInstance());
